...
public class NotesTableModel extends AbstractTableModel implements HSConstantsI {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case COL_ENTEREDBY_IDX:
                return notes.getEnteredBy();
            case COL_ENTEREDDATE_IDX:
                return notes.getEnteredDate();
        }
        return "";
    }
    ...
    public void setValueAt(Object value, int row, int col) {
        ...
        switch (col) {
            ...
            case COL_VISITNO_IDX:
                notes.setVisitNo(value.toString());
            case COL_NOTES_IDX:
                notes.setNotes(value.toString());
            case COL_ENTEREDBY_IDX:
                notes.setEnteredBy(value.toString());
            case COL_ENTEREDDATE_IDX:
                notes.setEnteredDate(value.toString());
        }
    }
